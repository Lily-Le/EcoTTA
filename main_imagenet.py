...
if __name__ == '__main__':
    ...
    parser.add_argument('--warmup_epoch', type=int, default=3, help='total epochs for warmup stage')
    parser.add_argument('--log_dir_pretrain', type=str, default='logs_pretrain', help='log directory for Tensorboard log output')
    #--------If mode = tta
