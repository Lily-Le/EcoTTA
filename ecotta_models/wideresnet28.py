...
base_model = load_model('Standard', './robust_models', 'cifar10', ThreatModel.corruptions).cuda()

class simplify_wideresnet28(Module):
    def __init__(self, model):
        ...
        self.module_list = [self.b1_l0,self.b1_l1,self.b1_l2,self.b1_l3, \
                        self.b2_l0,self.b2_l1,self.b2_l2,self.b2_l3, \
                        self.b3_l0,self.b3_l1,self.b3_l2,self.b3_l3]
        self.input_depth_list = [16, 160, 160, 160, \
                                 160, 320, 320, 320, \
                                 320, 640, 640, 640,  640]
        #
        # self.input_depth_list = [16, 32, 32, 32,\
        #                          32, 64, 64, 64, \
        #                          64, 128, 128, 128, 128]
        self.input_hight_list = [32, 32, 32, 32,\
                                 32, 16, 16, 16, \
                                 16,  8,  8,  8,  8]
        # classifier
...
simplified_model = simplify_wideresnet28(base_model)
...
class build_meta_block(Module):
    def __init__(self, in_out_depth_s, in_out_hight_s):
        ...
        self.meta_bn = nn.BatchNorm2d(in_out_depth_s[1]) #nn.Identity() #nn.BatchNorm2d(in_out_depth_s[1]) #nn.Identity()
